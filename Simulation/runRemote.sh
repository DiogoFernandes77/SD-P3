...
sshpass -p diogo-antonio ssh sd306@l040101-ws08.ua.pt "kill -9 \$(/usr/sbin/lsof -i:22350 -t) 2> /dev/null"
...
sshpass -p diogo-antonio ssh sd306@l040101-ws08.ua.pt 'cd test/SDP3; echo -e " A iniciar DepartAirp"; java -Djava.rmi.server.codebase="http://l040101-ws09.ua.pt/sd306/test/SDP3/"\
    -Djava.rmi.server.useCodebaseOnly=true\
    -Djava.security.policy=java.policy\
...
sshpass -p diogo-antonio ssh sd306@l040101-ws06.ua.pt 'cd test/SDP3; echo -e " A iniciar hostess"; java -Djava.rmi.server.codebase="http://l040101-ws09.ua.pt/sd306/test/SDP3/"\
    -Djava.rmi.server.useCodebaseOnly=true\
    -Djava.security.policy=java.policy\
