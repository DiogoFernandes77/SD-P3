...
sshpass -p diogo-antonio ssh sd306@l040101-ws01.ua.pt 'cd test/SDP3 ; unzip -uq Simulation.zip; javac $(find . -name "*.java") ;cd Simulation; mv java.policy ..'
...
sshpass -p diogo-antonio ssh sd306@l040101-ws02.ua.pt 'cd test/SDP3 ; unzip -uq Simulation.zip; javac $(find . -name "*.java");cd Simulation; mv java.policy ..'
echo "Machine 3"
...
sshpass -p diogo-antonio ssh sd306@l040101-ws03.ua.pt 'cd test/SDP3 ; unzip -uq Simulation.zip; javac $(find . -name "*.java");cd Simulation; mv java.policy ..'
echo "Machine 4"
...
sshpass -p diogo-antonio ssh sd306@l040101-ws04.ua.pt 'cd test/SDP3 ; unzip -uq Simulation.zip; javac $(find . -name "*.java");cd Simulation; mv java.policy ..'
echo "Machine 5"
...
sshpass -p diogo-antonio ssh sd306@l040101-ws05.ua.pt 'cd test/SDP3 ; unzip -uq Simulation.zip; javac $(find . -name "*.java");cd Simulation; mv java.policy ..'
echo "Machine 6"
...
sshpass -p diogo-antonio ssh sd306@l040101-ws06.ua.pt 'cd test/SDP3 ; unzip -uq Simulation.zip; javac $(find . -name "*.java");cd Simulation; mv java.policy ..'
echo "Machine 7"
...
sshpass -p diogo-antonio ssh sd306@l040101-ws07.ua.pt 'cd test/SDP3 ; unzip -uq Simulation.zip; javac $(find . -name "*.java");cd Simulation; mv java.policy ..'
echo "Machine 8"
...
sshpass -p diogo-antonio ssh sd306@l040101-ws08.ua.pt 'cd test/SDP3 ; unzip -uq Simulation.zip; javac $(find . -name "*.java");cd Simulation; mv java.policy ..'
echo "Machine 9"
...
sshpass -p diogo-antonio ssh sd306@l040101-ws09.ua.pt 'cd test/SDP3 ; unzip -uq Simulation.zip; javac $(find . -name "*.java");cd Simulation; mv java.policy ..'
